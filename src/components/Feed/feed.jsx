    ...
    return (
            ...
            <div className="feed">
                <div className="feed-header">
                    ...
                    {loggedUser.username && <div onClick={handleUserClick}>
                ...
                {(userTab&&loggedUser.username) && <UserAccount posts={posts} username={loggedUser.username} bio={'Hello! I develop software and this is one of my React projects'} accountname = {'Samuel Muhigirwa'}/>}
            </div>
    )
}